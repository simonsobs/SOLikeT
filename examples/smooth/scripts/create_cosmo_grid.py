...
MFLike: InputDict = {
    "likelihood": yaml_load_file("like_mflike.yaml"),
...
LensingLike: InputDict = {
    "likelihood": yaml_load_file("like_LensingLikelihood.yaml"),
    "params": yaml_load_file("params_cosmo_smooth.yaml"),
    "theory": yaml_load_file("theory_camb.yaml") | yaml_load_file("theory_ccl.yaml"),
}

ShearKappaLike: InputDict = {
    "likelihood": yaml_load_file("like_shearkappa.yaml"),
    "params": yaml_load_file("params_cosmo_smooth.yaml")
