...
class szutils(object):
    ...
    def P_Yo(self, LgY, M, z, param_vals, Ez_fn):
        Om = param_vals["om"]
        Ob = param_vals["ob"]
        OL = 1.0 - Om
        H0 = param_vals["H0"]
    ...
    def Pfunc_per_parallel(self, Marr, zarr, Y_c, Y_err, param_vals, Ez_fn):
        ...
        P_Y = np.nan_to_num(self.P_Yo(self.LgY, Marr, zarr, param_vals, Ez_fn))
...
# ------------------------------------------------------------------------------------------------------------
def calcFRel(z, M500, cosmoModel, obsFreqGHz=148.0, Ez_fn=None):
...
def y0FromLogM500(
    ...
    #     fRels.append(calcFRel(z, M500, cosmoModel, obsFreqGHz=obsFreqGHz, Ez_fn=Ez_fn))
