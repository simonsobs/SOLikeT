...
def project_ksz(tht, M, z, beam_txt, model_params, provider): #input_model
    ...
    rho2D_beam = interp1d(r.flatten(),convolvedProfMap.flatten(), kind='linear', bounds_error=False, fill_value=0.)(thta)
    rho2D2_beam = interp1d(r.flatten(),convolvedProfMap2.flatten(), kind='linear', bounds_error=False, fill_value=0.)(thta2)
