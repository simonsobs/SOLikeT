...
class SZ_PS_bandpower_Likelihood(GaussianLikelihood):
    ...
    def initialize(self):
        ...
        # we use the diagonal covariance from Planck paper
        self.covmat = self.cvg
...
class SZ_PS_bandpower_Theory(Theory):
    ...
    def calculate(self, state, want_derived=False, **params_values_dict):
        ...
        # A_sz_1 = params_values_dict['A_sz_1']
        # A_sz_2 = params_values_dict['A_sz_2']
        # A_sz_3 = params_values_dict['A_sz_3']
        # A_sz_4 = params_values_dict['A_sz_4']
        # A_sz_5 = params_values_dict['A_sz_5']
        # A_sz_6 = params_values_dict['A_sz_6']
        # A_sz_7 = params_values_dict['A_sz_7']
        # A_sz_8 = params_values_dict['A_sz_8']
        # A_sz_9 = params_values_dict['A_sz_9']
        # A_sz_10 = params_values_dict['A_sz_10']
        # A_sz_11 = params_values_dict['A_sz_11']
        # A_sz_12 = params_values_dict['A_sz_12']
        # A_sz_13 = params_values_dict['A_sz_13']
        # A_sz_14 = params_values_dict['A_sz_14']
        # A_sz_15 = params_values_dict['A_sz_15']
        # A_sz_16 = params_values_dict['A_sz_16']
        # A_sz_17 = params_values_dict['A_sz_17']
        # A_sz_18 = params_values_dict['A_sz_18']
        nbins = 18
        tsz = np.zeros(nbins)

        for i in range(1,nbins+1):
            p_str = 'A_sz_' + str(i)
            tsz[i-1] = params_values_dict[p_str]
